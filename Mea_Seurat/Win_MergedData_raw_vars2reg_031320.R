...
# Data Set 1: Project "OctoSeq1_MTnorm2"
...
raw1 <- CreateSeuratObject(counts = raw1, project = "OctoSeq1_MTnorm2", min.cells = 3, min.features = 200)
raw1
...
# Data Set 2: Project "OctoSeq2_MTnorm2"
...
raw2 <- CreateSeuratObject(counts = raw2, project = "OctoSeq2_MTnorm2", min.cells = 3, min.features = 200)
raw2
...
# Data Set 3: Project "OctoSeq3_MTnorm2"
...
raw3 <- CreateSeuratObject(counts = raw3, project = "OctoSeq3_MTnorm2", min.cells = 3, min.features = 200)
raw3
