...
# Data Set 1: Project "OctoSeq1_Hisat"
raw1 <- Read10X(data.dir = "Y:/OctoSeq_For_Seurat/OctoSeq1_Hisat/raw_feature_bc_matrix")
...
raw1 <- CreateSeuratObject(counts = raw1, project = "OctoSeq1_Hisat", min.cells = 3, min.features = 200)
raw1
...
saveRDS(raw1.norm, file = "/Users/Hannah\ Bishop/Desktop/MeaS/Seurat/OSr1MTnorm2.rds")
...
# Data Set 2: Project "OctoSeq2_Hisat"

raw2 <- Read10X(data.dir = "Y:/OctoSeq_For_Seurat/OctoSeq2.1_Hisat/raw_feature_bc_matrix")
...
raw2 <- CreateSeuratObject(counts = raw2, project = "OctoSeq2_Hisat", min.cells = 3, min.features = 200)
raw2
...
saveRDS(raw2.norm, file = "/Users/Hannah\ Bishop/Desktop/MeaS/Seurat/OSr2MTnorm2.rds")
...
# Data Set 3: Project "OctoSeq3_Hisat"

raw3 <- Read10X(data.dir = "Y:/OctoSeq_For_Seurat/OctoSeq2.2_Hisat/raw_feature_bc_matrix")
...
raw3 <- CreateSeuratObject(counts = raw3, project = "OctoSeq3_Hisat", min.cells = 3, min.features = 200)
raw3
...
saveRDS(raw3.norm, file = "/Users/Hannah\ Bishop/Desktop/MeaS/Seurat/OSr3MTnorm2.rds")
