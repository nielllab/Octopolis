---
title: "CCA integration of v3 chemistry datasets (scTransform Normalization)"
author: "jos"
date: "05/31/2020"
output:
  html_document:
...
```
# Objective: use a for loop to read in and process v3 data sets from the original GTF and conduct CCA integration with scTransform normalization.
```{r, echo = FALSE}
# to knit document, use the following command: rmarkdown::render("C:/Users/Hannah Bishop/Desktop/GitHubCode/Octopolis/Orig_v3_scT_CCA.Rmd") ~30m
...
saveRDS(all_list, "C:/Users/Hannah Bishop/Desktop/MeaS/all_list_scT.rds")
...
all.anchors <- FindIntegrationAnchors(object.list = all_list[2:3],
...
saveRDS(allnorm.integrated, "C:/Users/Hannah Bishop/Desktop/MeaS/allscTCCAV3.rds")
```

## Read in integrated dataset
```{r, echo = FALSE}
all <- readRDS("C:/Users/Hannah Bishop/Desktop/MeaS/allscTCCAV3.rds")
