...
ggene_ocbim <- read.csv("/Users/crisniell/Desktop/gene lists/GeneIDs - ggene ocbim minimap.csv", stringsAsFactors = FALSE) #temp master
...
for (i in 1:nrow(gene_master)){
  ...
  if (length(loc) ==1){
    ...
    add_row(gg_table, ggenes = gene_master$g_gene[i],manual_desc = gene_master$gene_desc[i])
  }
}
```
