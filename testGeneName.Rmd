...
gene_master <- read_sheet(gsheet_file,range = "GGene Temp Master") #temp master
...
for (i in 1:nrow(gg_table)){
  ...
  if (gg_table$merge_desc[i] ==' + '){  # demarcate genes with no identified matches
...
write.csv(gg_table, "/Users/crisniell/Desktop/gene lists/merged_ggenes_slop.csv")
```
...
for (g in 1:length(genes)){
  loc = which(gg_table$ggenes == genes[[g]])
