...
```{r, echo = FALSE, eval = TRUE}
DefaultAssay(all.tree) <- "SCT"
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_092121names/sct_top30clustersInclNoIDdot_sctassay_final_14x11.pdf",
    width = 14, # The width of the plot in inches
    height = 11)
for (m in 1:(nlevels((all.tree$seurat_clusters)) - 1)){
  clustermarkers_i <- FindMarkers(all.tree, ident.1 = 5, logfc.threshold = 0.25, test.use = "roc", only.pos = TRUE)
...
for (n in 1:length(nodes)){ 
  ...
  nodeName = paste("/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_092121names/", "node", nodes[n], "_top30", ".csv", sep = "")
  ...
  nodeName = paste("/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_092121names/", "node", nodes[n], "_bottom30", ".csv", sep = "")
