...
replaceLabelsY <- function(p,gene,desc){
  ...
  for (i in 1:length(oldylabels)){
    loc<-which(gene==(oldylabels[[i]])) # i/ind 4 = 919, G34789, neuroendocrine protein/ label = paste(genelabels[919], "-", namelist[919]) 
    if (length(loc)> 0) {
...
gene_master<- read.csv("/Users/josongco/Desktop/merged_ggenes.csv", stringsAsFactors = FALSE) #updated 090321 in google drive #merged_ggenes

pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_heatmap.pdf",
...
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_vizdim.pdf",
    width = 8, # The width of the plot in inches
    height = 8)
for (i in 1:50){
  ...
  print(p)
  print(features)
  PCName = paste("/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/", "PC", i, ".csv", sep = "")
  write.csv(features, PCName)
}
dev.off()

pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_elbow.pdf",
    width = 8, # The width of the plot in inches
    height = 8)
...
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_umap.pdf",
    width = 8, # The width of the plot in inches
    height = 5)
...
```{r, echo = TRUE}
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_hierarchicaltree_umap.pdf",
    width = 8, # The width of the plot in inches
    height = 5)
...
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_insitugenes_dot.pdf",
    width = 8, # The width of the plot in inches
    height = 8)
...
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_insitugenes_feat.pdf",
    width = 8, # The width of the plot in inches
    height = 5)
...
```{r, echo = FALSE, eval = TRUE}
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_top30clustersdot.pdf",
    width = 8, # The width of the plot in inches
    height = 8)
for (m in 1:(nlevels((all.tree$seurat_clusters)) - 1)){
  ...
  clustermarkers_i %>%
   ...
   top30<-addGeneNamesTable(top30,top30$geneID,gene_master$ggenes, gene_master$merge_desc)
     clusterName = paste("/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/", "cluster", m, "_top30", ".csv", sep = "")
...
pdf(file = "/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/sct_nodesdot.pdf",
    width = 8, # The width of the plot in inches
    height = 8)
...
for (n in 1:length(nodes)){
  ...
  nodemarkersROC %>%
    top_n(n = 30, wt = diff_exp) ->top30
  top30<-addGeneNamesTable(top30,top30$geneID,gene_master$ggenes, gene_master$merge_desc)
  nodeName = paste("/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/", "node", n, "_top30", ".csv", sep = "")
  write.csv(top30, nodeName)
  nodemarkersROC %>%
    top_n(n = -30, wt = diff_exp) ->bottom30
  top30<-addGeneNamesTable(bottom30,top30$geneID,gene_master$ggenes, gene_master$merge_desc)
  nodeName = paste("/Users/josongco/Desktop/ABD/FinalSeqData/hifiasm5cells_090621names/", "node", n, "_bottom30", ".csv", sep = "")
...
C2H2s <- read.csv("/Users/josongco/Desktop/GeneIDs - C2H2s.csv",stringsAsFactors=FALSE) # Neuro genes with updated GeneIDs - More Neuro
...
for (i in 1:nrow(C2H2s)){
  ...
  if (length(loc)>0 & str_length(gene)>0) {
    ...
    genelabels<-c(genelabels, gene_master$full_ocbim[[loc[1]]])
  } else {
    nomatch <- c(nomatch,C2H2s[[i,4]])
  }
  #print(genelist)
}
