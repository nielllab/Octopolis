...
```{r, echo = FALSE}
# to knit document, use the following command: rmarkdown::render("/Users/josongco/Desktop/FinalSeqData/scT_CCA.Rmd") ~30m [rename file when saved so code doesn't overwrite while producing next html]
