...
# read in csv namekey
namekey <- read.csv("fulldf_namekey.csv", stringsAsFactors = FALSE) # geneIDs_miniNCBI_fulldf_namekey.csv
...
print(namekeyDict[["OCTOGene.1"]]) #should print "OG.1"
print(namekeyDict[["OCTOGene.10032"]]) #should print "NA-Oc29021-OG.100" ; now prints anaphase-promoting-complex-subunit-7-OG10032-OB29021"
```
...
saveRDS(all_list, "~/hisatAll_list9120.rds")
