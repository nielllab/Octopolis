...
# read in csv namekey
namekey <- read.csv("fulldf_namekey.csv", stringsAsFactors = FALSE)
...
print(namekeyDict[["OCTOGene.10032"]]) #should print "NA-Oc29021-OG.100"
```

```{r}
ct = 1
for(f in 17:18){ #New gtf, NextSeq + HiSeq from directory master
