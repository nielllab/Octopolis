...
# "~/Google Drive/miller niell octo seq/projects data/scRNAseq/Seurat/gene lists/geneIDs_miniNCBI_namekey_Sep3.csv" (9320)
...
print(namekeyDict[["OCTOGene.1"]]) #should print "OG.1" ; did not work
