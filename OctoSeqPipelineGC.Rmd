...
# "~/Google Drive/miller niell octo seq/project data/scRNAseq/Seurat/gene lists/geneIDs_miniNCBI_namekey_Sep3.csv" (9320)
...
print(namekeyDict[["OCTOGene.1"]]) #should print "OG.1" ; did not work (error: Error in namekeyDict[["OCTOGene.1"]] : subscript out of bounds)
print(namekeyDict[["OCTOGene.10032"]]) #should print "NA-Oc29021-OG.100" ; now prints anaphase-promoting-complex-subunit-7-OG10032-OB29021" ; now prints "NA-anaphase-promoting-complex-subunit-7"
```
...
saveRDS(all_list, "~/hisatAll_list9320.rds")
