---
title: "Straight merge of all three datasets-with updated csv"
author: "jos"
date: "05/04/2020"
output:
  html_document:
...
## Read in data
Using the OctoSeqPipeline Code, I used a for loop to read in all three datasets from the original GTF. I set parameters to include a min.cell = 3 and min.features = 200.
```{r , echo = FALSE}
# to knit document, use the following code: rmarkdown::render("/Users/josongco/Desktop/SeqData/Code/OSall_30pcs30dimsres1_normSTR8merge_edited.Rmd")
library(Seurat)
library(Matrix)
library(ggplot2)
library(sctransform)
...
```{r}
all <- readRDS("/Users/josongco/Desktop/SeqData/allNorm_str8merge.rds")
