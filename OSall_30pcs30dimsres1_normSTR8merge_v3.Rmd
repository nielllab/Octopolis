---
title: "Straight merge of v3 chemistry-with updated csv"
author: "jos"
date: "05/11/2020"
output:
  html_document:
...
```{r , echo = FALSE}
# to knit document, use the following code: rmarkdown::render("/Users/josongco/Desktop/SeqData/Code/OSall_30pcs30dimsres1_normSTR8merge_v3.Rmd")
library(Seurat)
library(Matrix)
library(ggplot2)
library(sctransform)
...
saveRDS(all_list, "/Users/josongco/Desktop/SeqData/allnormV3.rds")
all <- merge(x = all_list[[2]], y = all_list[[3]], add.cell.ids = project = paste("Run", i, sep = ""), project = "StdN_str8_v3")
