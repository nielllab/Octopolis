...
```{r, echo = FALSE}
# to knit document, use the following command: rmarkdown::render("/Users/josongco/Documents/GitHub/Octopolis/OSall_30pcs30dimsres1_scTCCA_RNAftplt_V3.Rmd") ~30m
...
saveRDS(allnorm.integrated, "/Users/josongco/Desktop/SeqData/allscTCCAV3.rds")
```
...
```{r, echo = FALSE}
all <- readRDS("/Users/josongco/Desktop/SeqData/allscTCCAV3.rds")
```
