---
title: "CCA integration of v3 datasets (std Normalization)"
author: "jos"
date: "05/31/2020"
output:
  html_document:
...
```{r, echo = FALSE}
# to knit document, use the following command: rmarkdown::render("C:/Users/Hannah Bishop/Desktop/GitHubCode/Octopolis/Orig_v3_StdN_CCA.Rmd") ~30m
...
saveRDS(allnorm.integrated, "C:/Users/Hannah Bishop/Desktop/MeaS/v3StdNCCA.rds")
```

## Read in integrated dataset
```{r, echo = FALSE}
all <- readRDS("C:/Users/Hannah Bishop/Desktop/MeaS/v3StdNCCA.rds")
