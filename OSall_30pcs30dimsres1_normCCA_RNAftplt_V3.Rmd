---
title: "CCA integration of v3 chemistry datasets (RNA assay for featureplots)"
author: "jos"
date: "05/11/2020"
output:
  html_document:
...
```{r, echo = FALSE}
# to knit document, use the following command: rmarkdown::render("/Users/josongco/Documents/GitHub/Octopolis/OSall_30pcs30dimsres1_normCCA_RNAftplt_V3.Rmd") ~30m
...
all_list <- readRDS("/Users/josongco/all_listv3.rds")
...
allnorm.anchors <- FindIntegrationAnchors(all_list[2:3], dims = 1:30) # runs CCA ~30m; shows 0% but moves on to merging objects etc; found 43006 anchors -> 10257 [what is the ideal/typical number for anchors across three datasets?]; overall takes ~2-3hr; ~1hr for v3 chem
allnorm.integrated <- IntegrateData(anchorset = allnorm.anchors, dims = 1:30)

saveRDS(allnorm.integrated, "/Users/josongco/Desktop/SeqData/allnormCCAV3.rds")
```
...
```{r, echo = FALSE}
all <- readRDS("/Users/josongco/Desktop/SeqData/allnormCCAV3.rds")
